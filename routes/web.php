...
// 		Route::get('instagram-api-post', 'InstagramController@getInstagramPostAPIData')->name('instagram');
...
Route::get('/success-page/{id}', [ApplePayController::class, 'showSuccessPage'])->name('success.page');
	...
	Route::get('order-abandonment', 'ApiController@sendAbandonmentMailTest');
	...
	Route::post('/maillist', 'MailListFormController@MailListForm')->name('maillist');
