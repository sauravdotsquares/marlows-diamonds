function initLocationMap() {
    ...
    const s = new google.maps.Map(document.getElementById("location_map"), t);
    for (i = 0; i < e.length; i++) {
        const t = new google.maps.Marker({ position: e[i], map: s, icon: mapMarker });
        google.maps.event.addListener(t, "click", o), l.extend(t.position);
    }
    function o(e) {
        18 == s.zoom ? s.fitBounds(l) : (s.setCenter(new google.maps.LatLng(e.latLng.lat(), e.latLng.lng())), s.setZoom(18));
    }
    s.fitBounds(l);
}
function isIOS() {
...
$(document).ready(function () {
    ...
    $(".owlsliderone").owlCarousel({ loop: !0, margin: 20, nav: !0, dots: !1, responsive: { 0: { items: 2 }, 600: { items: 2 }, 992: { items: 3 } } }),
    ...
    $(".slider-review").owlCarousel({ loop: !0, margin: 30, nav: !0, responsive: { 320: { items: 1 }, 480: { items: 2 }, 769: { items: 3 }, 1e3: { items: 4 } } }),
    $(".photo-slider").owlCarousel({ loop: !0, margin: 10, nav: !1, responsive: { 320: { items: 1 },480: { items: 2 },769: { items: 3 },1300: { items: 4 },1500: { items: 5 } } }),
    $(".mobil-bar").owlCarousel({ loop: !0, margin: 10, nav: !1, dots: !1, responsive: { 0: { items: 1 }, 600: { items: 1 }, 1e3: { items: 1 } } }),
    ...
    $(window).scroll(function (e) {
        var t = $(window).height() / 3;
        $(window).scrollTop(), $(".header-main").outerHeight(!0);
    });
