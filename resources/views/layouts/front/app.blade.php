...
<head>
    ...
    <meta name="viewport"
        content="width=device-width, height=device-height, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0, user-scalable=0, target-densityDpi=device-dpi" />
    ...
    <script>
        ...
        })(window, document, 'script', 'dataLayer', 'GTM-WBT3LKH');
    </script>
