                                                    ...
                                                    @foreach(session('cart') as $id => $details)
                                                        ...
                                                        <tr class="checkcart-item">
                                                            ...
                                                            <td>
                                                                ...
                                                                <!-- <p> <span> RRP: </span> <del>{{MY_CURRENCY_SYMBOL}} {{$details['rrp_price']}}</del></p> -->
                                                                @endif
                                                                ...
                                                                <!-- <p> 
                                                                <span> Our Price: </span> 
                                                                <del> {{MY_CURRENCY_SYMBOL}}{{ isset($details['shop_price'])?$details['shop_price']:'' }}</del> </p> -->
                                                                @endif
                                                                @endif
        ...
        $(document).on('change', "[id^=yearlySupport]", function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('.checkout-order-review').html(response.orderview);
                }
            });
        });
