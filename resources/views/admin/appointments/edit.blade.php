...
<div class="content">
   ...
   <section class="content">
      <div class="container-fluid">
         <form action="{{ url('admin/appointments/edit/'.base64_encode($appointments->id)) }}" enctype="multipart/form-data" method="post"  id="cmsForm">
            @csrf
            <div class="row">
               <div class="col-md-8">
                     ...
                     <div class="card-body">
                        <div class="form-group">
                           <div class="form-label-group">
                              ...
                              <input type="text" id="title" name="title" value="{{ $appointments->title }}" class="form-control" placeholder="Name">
                           </div>
                        </div>
                        <div class="form-group">
                           <div class="form-label-group">
                              <label for="product_name">Email</label>
                              <input type="text" id="email" name="email" value="{{ $appointments->email }}" class="form-control" placeholder="Email" >
                           </div>
                        </div>
						 <div class="form-group">
                           <div class="form-label-group">
                              <label for="product_name">Phone</label>
                              <input type="text" id="phone" name="phone" value="{{ $appointments->phone }}" class="form-control" placeholder="Phone" >
                           </div>
                        </div>
                        <div class="form-group">
                           <div class="form-label-group">
