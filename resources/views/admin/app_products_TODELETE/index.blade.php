                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header text-right">
                            <a href="{{route($routePath. '.add')}}"><button type="button" class="btn btn-primary">Add New Product</button></a>
                                    ...
                                    @if(isset($getProducts) && !$getProducts->isEmpty())
                                        @foreach($getProducts as $key => $value)
                                            <tr>
                                                ...
                                                <td>
                                                    @if($value->status == 1)
                                                        <a  title="Change Status" href="javascript:void(0);" class="statusSwitch" data-record="{{$value->id}}" data-value="0"><i class="fa fa-check" aria-hidden="true"></i></a>
                                                    @else
