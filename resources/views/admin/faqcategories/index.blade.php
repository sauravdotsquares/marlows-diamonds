         ...
         <div class="col-12">
            <div class="card">
                     <div class="card-header">
                        ...
                        <a href="{{asset('admin/faqs/categories/create')}}">
                        ...
                        @foreach($getData as $key => $value)
                           <tr>
                              ...
                              <td>
                                 ...
                                 @endif
                                 <a title="Edit" href="{{asset('admin/faqs/categories/create/'.$value->slug)}}" class="btn btn-warning btn-sm"><i class="fa fa-edit " aria-hidden="true"></i></a>
