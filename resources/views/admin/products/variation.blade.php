                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <div class="form-label-group">
                            ...
                            <input data-field="vari_regular_price" type="text" id="vari_regular_price" name="data[{{$index}}][vari_regular_price]" class="form-control" placeholder="Regular Price" value="{{$variation['regular_price']}}">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <div class="form-label-group">
                            ...
                            <input data-field="mined_diamond_rrp" type="text" id="mined_diamond_rrp" name="data[{{$index}}][mined_diamond_rrp]" class="form-control" placeholder="Sale Price" value="{{$variation['mined_diamond_rrp']}}">
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <div class="form-label-group">
                            <label for="mined_diamond">Mined Diamond</label>
                            <input data-field="mined_diamond" type="text" id="mined_diamond" name="data[{{$index}}][mined_diamond]" class="form-control" placeholder="Sale Price" value="{{$variation['mined_diamond']}}">
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <div class="form-label-group">
                            ...
                            <input data-field="lab_grown_rrp" type="text" id="lab_grown_rrp" name="data[{{$index}}][lab_grown_rrp]" class="form-control" placeholder="Regular Price" value="{{$variation['lab_grown_rrp']}}">
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <div class="form-label-group">
                            ...
                            <input data-field="lab_grown" type="text" id="lab_grown" name="data[{{$index}}][lab_grown]" class="form-control" placeholder="Regular Price" value="{{$variation['lab_grown']}}">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <div class="form-label-group">
                            ...
                            @endif
                            <input data-field="vari_image" type="file" id="vari_image" name="data[{{$index}}][vari_image][]" class="form-control" multiple>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <div class="form-label-group">
                            ...
                            @endif
                            <input data-field="vari_video" type="file" id="vari_video" name="data[{{$index}}][vari_video][]" class="form-control" multiple>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <div class="form-label-group">
                            ...
                            <select data-field="vari_stock_status" name="data[{{$index}}][vari_stock_status]" id="vari_stock_status" class="form-control">
