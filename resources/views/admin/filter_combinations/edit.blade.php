        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-info">
                    ...
                    <?php $oldFormData = request()->old('form_data') ? request()->old('form_data') : $data; ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="slug" name="slug" placeholder="Enter slug" value="{{ request()->old('slug') ? request()->old('slug') : $data['slug'] }}">
                                        @error('slug') <span class="custom-error">{{ $message }}</span>  @enderror
                                    </div>
                                </div>
                            </div>
