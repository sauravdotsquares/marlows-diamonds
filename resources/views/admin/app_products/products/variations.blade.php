            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <?php
                            $request_data = request()->old() ? request()->old() : [1];
                        ...
                        <div class="card-body" id="append-data">
                            ...
                            <?php foreach ($request_data as $data_key => $data_value) { ?>
                                ...
                                <?php
                                    ...
                                    // $in_stock = !empty($data_value['variations']['attribute_id']) ? $data_value['variations']['attribute_id'] : '';
                                    $index = $data_key;
                                ...
                                <div class="data-information">
                                    ...
                                    <div class="form-group row">
                                        <?php if(!empty($attributeData) && count($attributeData)){ ?>
                                            <?php foreach ($attributeData as $attributeData_key => $attributeData_value) { ?>
                                                ...
                                                <input type="hidden" name="variation_data[{{$index}}][variations][attribute_id]" value="{{ $attributeData_value['product_attribute']['id']  }}" >
    
                                                <div class="form-label-group col-sm-3">
                                                    <select class="form-control" id="attr-{{ $attributeData_value['id'] }}" name="variation_data[{{$index}}][variations][data][{{$attributeData_value['id']}}]">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="form-label-group col-sm-12 col-md-6">
                                            ...
                                            <input type="hidden" id="variation_image_id" name="variation_data[{{$index}}][image_id]">
