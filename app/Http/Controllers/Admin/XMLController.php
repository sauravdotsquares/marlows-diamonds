...
class XMLController extends Controller
{
    public function XMLFunction()
    {
        ...
        // echo "<pre>";
        // print_r($getProductDataEngagementData);
        // die;

        // $getSendingData = [
        //     'variation_price' =>2457.00,
        //     'carat' =>'0.30-0.39',
        //     'color' =>'D',
        //     'clarity' =>'SI2',
        //     'grade' =>'EX',
        ...
        // // $getPriceDataProductPriceController = new ProductPriceController;
        // $getPriceDataProductPriceController = $this->getProductFinalPriceWithDiamondUsingXMLFiles($getSendingData);

        // echo "In the first function";
        // print_r(round($getPriceDataProductPriceController['settingPriceWithVat']));
        // die;
    ...
    public function getPriceCalculationFunction($diamondType,$category,$finalPrices)
    {
        ...
        if (in_array("18", $prod_categories))
        {
            ...
            return $regular_p_final['settingPriceWithVat'];

            // echo "In Engagement Jewellery<pre>";
            // print_r($regular_p_final['settingPriceWithVat']);
            // die;
