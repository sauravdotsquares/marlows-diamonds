...
class XMLController extends Controller
{
    ...
    /**
     * Get Price Calculations Functions
     *
     * @param [type] $productData
     * @param [type] $diamondType
     * @param [type] $finalPrices
     * @return void
     */
    ...
    /**
     * Get Product Final Price with diamond using XML files
     *
     * @param [type] $requestDataArray
     * @return void
     */
    ...
    /**
     * Get Actual setting price function
     *
     * @param [type] $slug
