...
class DekoPayController extends Controller
{
	...
	/**
	 * Generate dekopay form function
	 *
	 * @param [type] $order_id
	 * @return void
	 */
	...
	/**
	 * Call Deko Curl URL function
	 *
	 * @param [type] $order
	 * @param [type] $bool
	 * @param [type] $desc
	 * @param [type] $finCode
	 * @param [type] $depositAmt
	 * @return void
	 */
	...
	/**
	 * Get Dekopay Arguments Function
	 *
	 * @param [type] $order
	 * @return void
	 */
